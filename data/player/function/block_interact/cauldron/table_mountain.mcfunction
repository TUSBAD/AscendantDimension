#> player:block_interact/cauldron/table_mountain
# テーブルマウンテンで大釜を使ったとき
### Copyright © 2022 赤石愛
...
execute unless data block 10 113 -2240 {Command:"/fill 10 114 -2236 10 114 -2236 minecraft:water_cauldron[level=3] replace minecraft:water_cauldron[level=2]"} run advancement revoke @s only player:block_interact/interact_cauldron_in_table_mountain

#> player:block_interact/chest_event/
# インベントリに入手したときの処理
### Copyright © 2022 赤石愛
### This software is released under the MIT License, see LICENSE.

## テーブルマウンテンの試供品
execute unless entity @s[advancements={player:block_interact/chest_event={table_trialset_1=false,table_trialset_2=false,table_trialset_3=false}}] run function player:block_interact/chest_event/table_trialset

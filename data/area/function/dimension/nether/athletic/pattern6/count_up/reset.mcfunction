#> area:dimension/nether/athletic/pattern6/count_up/reset
# パターン６
### Copyright © 2022 赤石愛
...
execute in minecraft:overworld run schedule function area:dimension/nether/athletic/pattern6/count_up/1 1s

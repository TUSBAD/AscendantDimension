#> area:dimension/nether/athletic/hell_climb/start
# ヘルクライム
### Copyright © 2022 赤石愛
...
execute in minecraft:the_nether run playsound minecraft:entity.elder_guardian.curse master @a[x=-363,y=57,z=1282,dx=21,dy=100,dz=19] -352.0 20.0 1299.0 0.1 0.5 1
execute in minecraft:the_nether run tp 0-0-4-0-1 -331 16.5 1351

## 最初のスケジュール
schedule function area:dimension/nether/athletic/hell_climb/schedule 7s

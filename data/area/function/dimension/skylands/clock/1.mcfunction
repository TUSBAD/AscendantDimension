#> area:dimension/skylands/clock/1
# 時計島第１形態
### Copyright © 2022 赤石愛
...
### 時計島変身
execute in minecraft:overworld positioned 4001 47 4001 run function area:dimension/skylands/clock/clone

### 時計島の段階を記録
data modify storage area: clock_stage set value 1

#> area:dimension/skylands/clock/clone
# 時計島変身
### Copyright © 2022 赤石愛
...
fill 35 0 6 59 24 30 minecraft:command_block[facing=north]{auto:true,Command:"execute positioned ~ ~-0.4999 ~1 run function area:dimension/skylands/clock/set_spawner"} replace minecraft:crying_obsidian
### 南向きのコマブロを修正
fill 35 0 6 59 24 30 minecraft:crying_obsidian replace minecraft:command_block[facing=south]{auto:true}
fill 35 0 6 59 24 30 minecraft:command_block[facing=south]{auto:true,Command:"execute positioned ~ ~-0.4999 ~-1 run function area:dimension/skylands/clock/set_spawner"} replace minecraft:crying_obsidian
### 西向きのコマブロを修正
fill 35 0 6 59 24 30 minecraft:crying_obsidian replace minecraft:command_block[facing=west]{auto:true}
fill 35 0 6 59 24 30 minecraft:command_block[facing=west]{auto:true,Command:"execute positioned ~1 ~-0.4999 ~ run function area:dimension/skylands/clock/set_spawner"} replace minecraft:crying_obsidian
### 東向きのコマブロを修正
fill 35 0 6 59 24 30 minecraft:crying_obsidian replace minecraft:command_block[facing=east]{auto:true}
fill 35 0 6 59 24 30 minecraft:command_block[facing=east]{auto:true,Command:"execute positioned ~-1 ~-0.4999 ~ run function area:dimension/skylands/clock/set_spawner"} replace minecraft:crying_obsidian
...
fill 35 0 6 59 24 30 minecraft:command_block[facing=north]{auto:false,Command:"function area:dimension/skylands/clock/stop"} replace minecraft:crying_obsidian
### 南向きのコマブロを修正
fill 35 0 6 59 24 30 minecraft:crying_obsidian replace minecraft:command_block[facing=south]{auto:false}
fill 35 0 6 59 24 30 minecraft:command_block[facing=south]{auto:false,Command:"function area:dimension/skylands/clock/stop"} replace minecraft:crying_obsidian
### 西向きのコマブロを修正
fill 35 0 6 59 24 30 minecraft:crying_obsidian replace minecraft:command_block[facing=west]{auto:false}
fill 35 0 6 59 24 30 minecraft:command_block[facing=west]{auto:false,Command:"function area:dimension/skylands/clock/stop"} replace minecraft:crying_obsidian
### 東向きのコマブロを修正
fill 35 0 6 59 24 30 minecraft:crying_obsidian replace minecraft:command_block[facing=east]{auto:false}
fill 35 0 6 59 24 30 minecraft:command_block[facing=east]{auto:false,Command:"function area:dimension/skylands/clock/stop"} replace minecraft:crying_obsidian

### 時計島鳴らすよ
data modify storage area: clock_ring_time set value 180
execute in minecraft:overworld run schedule function area:dimension/skylands/clock/ring 1t

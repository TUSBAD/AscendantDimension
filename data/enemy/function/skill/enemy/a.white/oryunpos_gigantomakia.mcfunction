...
summon endermite ~ ~ ~ {NoGravity:1b,Silent:1b,Glowing:1b,Health:100f,Lifetime:300,Tags:["OryunposGigantomakia"],active_effects:[{id:"minecraft:invisibility",amplifier:126b,duration:2147483647,show_particles:0b}],Attributes:[{Name:"minecraft:max_health",Base:100}]}

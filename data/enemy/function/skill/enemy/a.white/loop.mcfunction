#> enemy:skill/enemy/a.white/loop
#
# オリュンポス・ギガンドマキアのtick処理
#
# @within enemy:skill/magic/oryunpos_gigantomakia/
...
execute if entity @e[tag=OryunposGigantomakia] run schedule function enemy:skill/enemy/a.white/loop 1

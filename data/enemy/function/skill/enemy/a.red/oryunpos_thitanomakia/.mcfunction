#> enemy:skill/enemy/a.red/oryunpos_thitanomakia/
#
# オリュンポス・ティタノマキア
#
# @within function enemy:skill/enemy/a.red/
...
execute as @e[distance=..32,type=zombified_piglin,tag=!SkillMob] run function enemy:skill/enemy/a.red/oryunpos_thitanomakia/effect

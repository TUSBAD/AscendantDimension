...
# 居縮
execute if entity @s[scores={Isukumi=1..}] run function skill:act/ninja/isukumi/schedule/

## 狩人
# ルカナントラップ
execute if entity @s[scores={Kasap=1..}] run function skill:act/archer/kasap_trap/schedule/
# ボミオストラップ
execute if entity @s[scores={Decelerate=1..}] run function skill:act/archer/poof_trap/schedule/

...
execute if data storage debug:spawner/set_spawner _.DebugId run function debug:tick/set_spawner

execute if data storage debug:spawner/set_block_spawner _.DebugId run function debug:tick/set_block_spawner

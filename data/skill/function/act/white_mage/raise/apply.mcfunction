#> skill:act/white_mage/raise/apply
# レイズをかける
### Copyright © 2022 赤石愛
...
### お墓の表示
summon minecraft:arrow ~ ~ ~ {Silent:true,damage:0d,life:580s,Tags:[TypeChecked],Passengers:[{id:"minecraft:area_effect_cloud",Radius:0.5f,RadiusOnUse:0f,DurationOnUse:0,duration:620,RadiusPerTick:0f,WaitTime:0,Age:0,Particle:{type:"minecraft:end_rod"},CustomName:'"✟"',CustomNameVisible:true,Tags:[RaisePoint,TypeChecked]}]}

#> skill:act/black_mage/snow/apply
# 雪の壁を出す
### Copyright © 2022 赤石愛
...
summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0.0f,RadiusOnUse:0f,DurationOnUse:0,Duration:100,RadiusPerTick:0f,WaitTime:0,Age:0,Particle:{type:"minecraft:end_rod"},CustomName:"{\"text\": \"\"}",CustomNameVisible:true,Tags:[Snow,TypeChecked]}
execute as @e[distance=..0.01,type=area_effect_cloud,tag=Snow] run tp @s ~ ~ ~ ~ 0

### スノウの判定を有効化
function skill:act/black_mage/snow/schedule/

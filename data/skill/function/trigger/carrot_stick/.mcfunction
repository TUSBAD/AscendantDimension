...
execute as @s[scores={CurrentMode=2250..2259}] run function skill:act/ninja/taiso/spell
execute as @s[scores={CurrentMode=2270..2279}] run function skill:act/ninja/syungokusatsu/carrot/spell
execute as @s[scores={CurrentMode=3290..3299}] run function skill:act/archer/crazy/spell
...
execute as @s[scores={CurrentMode=4250..4259}] run function skill:act/white_mage/syawa_/spell
execute as @s[scores={CurrentMode=4260..4269}] run function skill:act/white_mage/ora/spell
...
execute as @s[scores={CurrentMode=5260..5269}] run function skill:act/black_mage/mazikaru/spell
execute as @s[scores={CurrentMode=5270..5279}] run function skill:act/black_mage/syawa_/spell
execute as @s[scores={CurrentMode=5280..5289}] run function skill:act/black_mage/shadow/spell
...
execute as @s[scores={CurrentMode=6310..6319}] run function skill:act/summoner/furea/spell
execute as @s[scores={CurrentMode=6320..6329}] run function skill:act/summoner/abisu/spell
execute as @s[scores={CurrentMode=6330..6339}] run function skill:act/summoner/katatoro/spell

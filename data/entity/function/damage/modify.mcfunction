...
execute store result score _ AscendantAttack run data get storage entity: damage.ascendant
...
execute store result storage entity: damage.ascendant double 0.01 run scoreboard players operation _ AscendantAttack *= _ Calc

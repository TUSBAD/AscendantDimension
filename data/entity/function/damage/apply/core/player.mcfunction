...
execute if data storage entity: damage.deathcause run gamerule minecraft:show_death_messages false
...
execute if data storage entity: damage.deathcause run gamerule minecraft:show_death_messages true

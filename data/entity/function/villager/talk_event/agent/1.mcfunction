#> entity:villager/talk_event/agent/1
# エージェントとの会話１
### Copyright © 2022 赤石愛
...
execute store result storage entity: _ int -0.2 run scoreboard players operation @s AgentWarpCost *= @s AgentWarpCost
execute store result score @s AgentWarpCost run data get storage entity: _ -1

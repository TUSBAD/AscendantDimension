#> debug:spawner/copy_spawner/
# 最寄りのスポナーをコピーします

function #oh_my_dat:please
execute as @e[tag=Spawner,limit=1,sort=nearest,type=armor_stand,predicate=lib:spawner/is_vechicle_spawner] run function debug:spawner/copy_spawner/copy_entity

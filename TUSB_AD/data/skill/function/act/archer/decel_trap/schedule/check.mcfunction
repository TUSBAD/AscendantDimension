#> skill:act/archer/decel_trap/schedule/check
### ボミオストラップの効果判定
### Copyright © 2022 赤石愛
...
execute if entity @s[tag=Decel1] run effect give @e[distance=..5,type=#entity:mob,tag=Enemy] minecraft:slowness 1 2 false
execute if entity @s[tag=Decel2] run effect give @e[distance=..5,type=#entity:mob,tag=Enemy] minecraft:slowness 1 5 false

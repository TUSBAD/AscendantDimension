...
execute if score @s Choyaku matches 2..7 as @e[distance=..3,type=#entity:mob,tag=Enemy] run function score_damage:api/attack
execute if score @s Choyaku matches 8..12 as @e[distance=..6,type=#entity:mob,tag=Enemy] run function score_damage:api/attack
execute if score @s Choyaku matches 13.. as @e[distance=..9,type=#entity:mob,tag=Enemy] run function score_damage:api/attack

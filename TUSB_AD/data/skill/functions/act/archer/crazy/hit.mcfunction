...
execute as @e[tag=crazy] at @s run function skill:act/archer/crazy/otomitame
...
execute as @e[tag=crazy] as @e[type=player,distance=..10] run function player:effect/clear_bad_effect
...
execute if data storage skill: {_:true} in minecraft:overworld run schedule function skill:act/archer/crazy/hit 20t

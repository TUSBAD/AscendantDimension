#> skill:act/archer/wild_healing/apply
### ワイルドヒーリングの発動
### Copyright © 2022 赤石愛
### This software is released under the MIT License, see LICENSE.

playsound minecraft:entity.experience_orb.pickup master @a[distance=..16] ~ ~ ~ 1 1.9 0
...
### レベル２なら状態異常回復
execute if score @s CurrentMode matches 3221..3229 run function effect:clear_bad_effect

#> skill:act/white_mage/holy_soul_ignition/schedule/fly
...
execute as @e[distance=..10,type=#entity:mob,tag=Enemy] unless predicate skill:is_saturation at @s run function skill:act/white_mage/holy_soul_ignition/schedule/hit

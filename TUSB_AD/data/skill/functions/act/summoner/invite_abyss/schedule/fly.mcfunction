#> skill:act/summoner/invite_abyss/schedule/fly
...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#entity:mob,tag=Enemy] unless predicate skill:is_saturation at @s run function skill:act/summoner/invite_abyss/schedule/hit

#> skill:act/summoner/invite_abyss/schedule/zenntaikougeki
...
execute as @e[type=#entity:mob,tag=Enemy,distance=..20,limit=1,sort=nearest] run function score_damage:api/attack
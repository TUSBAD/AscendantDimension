#> skill:act/summoner/gold_basin/schedule/fly
### 金タライが飛んでいる演出
### Copyright © 2022 赤石愛
...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#lib:mob,tag=Enemy] unless predicate job:is_saturation at @s run function skill:act/summoner/gold_basin/schedule/hit

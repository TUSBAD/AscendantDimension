...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#lib:mob,tag=Enemy] unless predicate skill:is_saturation at @s run function skill:act/summoner/abisu/schedule/hit

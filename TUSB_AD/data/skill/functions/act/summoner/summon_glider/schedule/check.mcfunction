#> skill:act/summoner/summon_glider/schedule/check
### バルーン発射までの演出
### Copyright © 2022 赤石愛
...
execute as @e[distance=..1,type=phantom,tag=Glider,sort=nearest,limit=1] run function skill:act/summoner/summon_glider/schedule/set_motion

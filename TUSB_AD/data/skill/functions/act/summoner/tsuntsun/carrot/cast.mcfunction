#> skill:act/summoner/tsuntsun/carrot/cast
# つんつんを詠唱(624X)
### Copyright © 2022 赤石愛
...
execute as @a[distance=..30,tag=TsuntsunSnowGolem] at @s run function skill:act/summoner/tsuntsun/carrot/apply/snow_golem
execute as @a[distance=..30,tag=TsuntsunWolf] at @s run function skill:act/summoner/tsuntsun/carrot/apply/wolf
execute as @a[distance=..30,tag=TsuntsunIronGolem] at @s run function skill:act/summoner/tsuntsun/carrot/apply/iron_golem

...
execute positioned ~-0.5 ~1 ~-0.5 as @e[dy=0,type=#lib:mob,tag=Enemy] unless predicate job:is_saturation at @s run function skill:act/summoner/summon_petit_black/black/hit

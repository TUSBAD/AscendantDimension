#> skill:act/black_mage/lightning_shower/cast
...
execute if data storage skill: {_:true} in minecraft:overworld run schedule function skill:act/black_mage/lightning_shower/apply 1s

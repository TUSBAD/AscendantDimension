...
execute as @e[tag=shadowpoint] if score @s TUSB = _ TUSB at @s as @e[distance=..15,type=#lib:mob,tag=Enemy] at @s run function skill:act/black_mage/shadow/attack/target

...
execute as @e[distance=..8,type=#lib:mob,type=!#lib:resist_ice,tag=Enemy] unless predicate job:is_saturation at @s run function skill:act/black_mage/ice_storm/schedule/hit

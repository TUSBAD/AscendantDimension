#> skill:act/black_mage/shadow_bolt/apply
...
execute as @e[distance=..15,type=#entity:mob,tag=Enemy,sort=nearest,limit=1] at @s run particle dust 0.490 0.122 0.490 9 ~ ~8 ~ 4 0 4 0.16 300 normal
execute as @e[distance=..15,type=#entity:mob,tag=Enemy,sort=nearest,limit=1] at @s run particle dust 0.702 0.663 0.690 9 ~ ~8 ~ 4 0 4 0.16 300 normal

schedule function skill:act/black_mage/shadow_bolt/attack/ 25t append

...
execute as @s[scores={CurrentMode=2200..2209}] run function skill:act/ninja/suriken/throw
execute as @s[scores={CurrentMode=2230..2239}] run function skill:act/ninja/isukumi/throw

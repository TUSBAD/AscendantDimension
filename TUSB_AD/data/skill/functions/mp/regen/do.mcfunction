...
execute if entity @s[predicate=player:effects/is_hunger] run scoreboard players set @s MPRecovery 0
...
# MPバー反映
execute if score _ _ matches 1 run function skill:mp/bar/set

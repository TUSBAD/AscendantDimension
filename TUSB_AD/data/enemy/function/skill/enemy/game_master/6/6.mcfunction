#> enemy:skill/enemy/game_master/6/6
#
#
#
# @within function enemy:skill/enemy/game_master/6/
...
# multi
    execute if score _ game_master.reward matches 2.. run function enemy:skill/enemy/game_master/6/6.multi

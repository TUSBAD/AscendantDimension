#> enemy:skill/enemy/shinsei_king/summon_blackhole/result
...
execute at @e[type=marker,tag=Blackhole] run function enemy:skill/enemy/shinsei_king/summon_blackhole/particle/

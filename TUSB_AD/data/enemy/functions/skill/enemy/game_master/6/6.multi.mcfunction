#> enemy:skill/enemy/game_master/6/6.multi
#
#
#
# @within function enemy:skill/enemy/game_master/6/6
...
# damage
    ...
    # attack
        execute at @e[limit=1,tag=GameMaster] as @a[distance=..60,tag=GameMasterBattle] if predicate player:effects/is_poison run function score_damage:api/attack
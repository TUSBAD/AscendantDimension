#> enemy:skill/enemy/a.pale/hadesu_nightmare
#
# ハデスナイトメア
#
# @within function enemy:skill/enemy/a.pale/
...
execute as @a[distance=..32] if predicate player:effects/is_poison run scoreboard players set @s MP 0

...
data modify storage asset: mob set value {Profession:0b,Passengers:[{NoGravity:1b,Passengers:[{NoGravity:1b,CustomName:'{"text":"ガストの旦那"}',Health:1000.0f,Attributes:[{Base:1000.0d,Name:"minecraft:maxHealth"},{Base:99.0d,Name:"minecraft:followRange"},{Base:1.0d,Name:"minecraft:knockbackResistance"}],id:"ghast",ExplosionPower:16,CustomNameVisible:1b}],Health:500.0f,Attributes:[{Base:500.0d,Name:"minecraft:maxHealth"},{Base:1.0d,Name:"minecraft:knockbackResistance"}],Silent:1b,NoAI:1b,id:"giant"}],DeathTime:19s,Health:0.0f,Silent:1b,id:"villager"}

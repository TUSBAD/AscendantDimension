...
data modify storage asset: mob set value {Passengers: [{Passengers: [{CustomName: '{"text":"10式0.3m小銃"}', Health: 60.0f, Attributes: [{Base: 100.0d, Name: "minecraft:max_health"}, {Base: 32.0d, Name: "minecraft:follow_range"}, {Base: 10.0d, Name: "minecraft:attack_damage"}], Silent: 1b, id: "minecraft:guardian", active_effects: [{show_particles: 0b, duration: 2147483647, Id: 12b, amplifier: 0b}, {show_particles: 0b, duration: 2147483647, Id: 14b, amplifier: 0b}]}], CustomName: '{"text":"SAT"}', Health: 60.0f, Attributes: [{Base: 60.0d, Name: "minecraft:max_health"}, {Base: 32.0d, Name: "minecraft:follow_range"}, {Base: 5.0d, Name: "minecraft:attack_damage"}, {Base: 0.4d, Name: "minecraft:movement_speed"}, {Base: 0.5d, Name: "minecraft:knockback_resistance"}, {Base: 12.0d, Name: "minecraft:armor"}], id: "minecraft:cave_spider", Tags: ["CanSpin"], CustomNameVisible: 1b}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, Id: 14b, amplifier: 0b}]}

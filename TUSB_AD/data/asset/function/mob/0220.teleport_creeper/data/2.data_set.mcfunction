...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Fuse: 35s, CustomName: '{"text":"ﾃﾚﾎﾟｰﾄｸﾘｰﾊﾟｰ"}', Health: 60.0f, Attributes: [{Base: 60.0d, Name: "minecraft:max_health"}, {Base: 0.7d, Name: "minecraft:movement_speed"}, {Base: 0.0d, Name: "minecraft:knockback_resistance"}, {Base: 32.0d, Name: "minecraft:follow_range"}], DeathLootTable: "empty", id: "minecraft:creeper", ExplosionRadius: 3b}, {Particle: "happy_villager", Radius: 0.05f, ReapplicationDelay: 0, CustomName: '{"text":"テレポートオーラ"}', RadiusOnUse: 0.0f, duration: 60, id: "minecraft:area_effect_cloud", effects: []}], CustomName: '{"text":"ﾃﾚﾎﾟｰﾄｸﾘｰﾊﾟｰ"}', Health: 20.0f, Attributes: [{Base: 20.0d, Name: "minecraft:max_health"}], Silent: 1b, id: "minecraft:bat", Tags: ["SkillMob", "WarpOnly"], active_effects: [{show_particles: 0b, duration: 2147483647, Id: 14b, amplifier: 127b}, {show_particles: 0b, duration: 2147483647, Id: 20b, amplifier: 0b}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}

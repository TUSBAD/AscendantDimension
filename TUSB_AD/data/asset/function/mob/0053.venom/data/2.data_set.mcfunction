...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Item: {id: "minecraft:lingering_potion", tag: {custom_potion_effects: [{show_particles: 1b, duration: 200, Id: 19b, amplifier: 4b}], Potion: "minecraft:water"}}, Potion: {id: "minecraft:lingering_potion", tag: {custom_potion_effects: [{show_particles: 1b, duration: 200, Id: 19b, amplifier: 4b}], Potion: "minecraft:water"}}, id: "minecraft:potion"}], CustomName: '{"text":"ﾍﾟｲﾙｽﾊﾟｲﾀﾞｰ"}', Health: 70.0f, Attributes: [{Base: 70.0d, Name: "minecraft:max_health"}, {Base: 48.0d, Name: "minecraft:follow_range"}, {Base: 1.0d, Name: "minecraft:knockback_resistance"}, {Base: 0.4d, Name: "minecraft:movement_speed"}, {Base: 1.0d, Name: "minecraft:attack_damage"}], id: "minecraft:cave_spider"}, {Passengers: [{Particle: "entity_effect", Radius: 1.55f, ReapplicationDelay: 10, CustomName: '{"text":"ｳﾞｪﾉﾑﾐｽﾄ"}', Color: 52312, duration: 999, id: "minecraft:area_effect_cloud", effects: [{show_particles: 1b, duration: 200, Id: 19b, amplifier: 60b}, {show_particles: 1b, duration: 200, Id: 4b, amplifier: 10b}]}], CustomName: '{"text":"ｳﾞｪﾉﾑ"}', Health: 250.0f, Attributes: [{Base: 250.0d, Name: "minecraft:max_health"}, {Base: 48.0d, Name: "minecraft:follow_range"}, {Base: 1.0d, Name: "minecraft:knockback_resistance"}, {Base: 0.29d, Name: "minecraft:movement_speed"}, {Base: 0.0d, Name: "minecraft:attack_damage"}], Silent: 1b, id: "minecraft:endermite", active_effects: [{show_particles: 0b, duration: 2147483647, Id: 14b, amplifier: 0b}, {show_particles: 0b, duration: 2147483647, Id: 8b, amplifier: 17b}, {show_particles: 0b, duration: 2147483647, Id: 25b, amplifier: -2b}]}, {Fuse: 5s, Passengers: [{Particle: "happy_villager", Radius: 0.001f, CustomName: '{"text":"飾"}', duration: 999, id: "minecraft:area_effect_cloud", effects: []}, {Item: {id: "minecraft:lingering_potion", tag: {custom_potion_effects: [{show_particles: 1b, duration: 200, Id: 19b, amplifier: 4b}], Potion: "minecraft:water"}}, Potion: {id: "minecraft:lingering_potion", tag: {custom_potion_effects: [{show_particles: 1b, duration: 200, Id: 19b, amplifier: 4b}], Potion: "minecraft:water"}}, id: "minecraft:potion"}], CustomName: '{"text":"ﾍﾟｲﾙｸﾘｰﾊﾟｰ"}', Health: 100.0f, Attributes: [{Base: 100.0d, Name: "minecraft:max_health"}, {Base: 48.0d, Name: "minecraft:follow_range"}, {Base: 1.0d, Name: "minecraft:knockback_resistance"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 1.0d, Name: "minecraft:attack_damage"}], Silent: 1b, id: "minecraft:creeper", ExplosionRadius: 0b, active_effects: [{show_particles: 1b, duration: 2147483647, Id: 14b, amplifier: 0b}, {show_particles: 1b, duration: 1200, Id: 10b, amplifier: 2b}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 20, Id: 14b, amplifier: 0b}]}

...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Passengers: [{Passengers: [{Passengers: [{CustomName: '{"text":"ママレード"}', Attributes: [{Base: 10, Name: "minecraft:follow_range"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 3, Name: "minecraft:attack_damage"}], id: "minecraft:endermite", CustomNameVisible: 1b}], CustomName: '{"text":"ソング"}', Attributes: [{Base: 10, Name: "minecraft:follow_range"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 3, Name: "minecraft:attack_damage"}], id: "minecraft:silverfish", CustomNameVisible: 0b}], CustomName: '{"text":"シュガー"}', Attributes: [{Base: 10, Name: "minecraft:follow_range"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 3, Name: "minecraft:attack_damage"}], id: "minecraft:endermite", CustomNameVisible: 0b}], CustomName: '{"text":"ピーナッツ"}', Attributes: [{Base: 10, Name: "minecraft:follow_range"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 3, Name: "minecraft:attack_damage"}], id: "minecraft:silverfish", CustomNameVisible: 0b}], CustomName: '{"text":"ビター"}', Attributes: [{Base: 10, Name: "minecraft:follow_range"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 3, Name: "minecraft:attack_damage"}], id: "minecraft:endermite", CustomNameVisible: 0b}], CustomName: '{"text":"ステップ"}', Attributes: [{Base: 10, Name: "minecraft:follow_range"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 3, Name: "minecraft:attack_damage"}], id: "minecraft:silverfish", CustomNameVisible: 0b}

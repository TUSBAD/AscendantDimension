...
data modify storage asset: mob set value {Passengers: [{Passengers: [{Passengers: [{Particle: "lava", Radius: 1.5f, ReapplicationDelay: 0, duration: 600, id: "minecraft:area_effect_cloud"}, {Particle: "falling_dust air", Radius: 5.55f, ReapplicationDelay: 0, CustomName: '{"text":"ファイアーオーラ"}', duration: 600, id: "minecraft:area_effect_cloud", effects: [{duration: 180, Id: 4b, amplifier: 10b}, {duration: 6, Id: 12b, amplifier: 127b}, {duration: 650, Id: 17b, amplifier: 2b}]}, {CustomName: '{"text":"ヘルキューブ"}', Health: 180.0f, ArmorItems: [{}, {}, {}, {id: "minecraft:iron_helmet", Count: 65b, tag: {Enchantments: [{lvl: 5s, id: "minecraft:thorns"}, {lvl: 5s, id: "minecraft:projectile_protection"}], Damage: 0}}], Attributes: [{Base: 180.0d, Name: "minecraft:max_health"}, {Base: 20.0d, Name: "minecraft:attack_damage"}, {Base: 1.0d, Name: "minecraft:knockback_resistance"}, {Base: 64.0d, Name: "minecraft:follow_range"}], id: "minecraft:blaze", active_effects: [{show_particles: 0b, duration: 2147483647, Id: 14b, amplifier: 127b}]}], CustomName: '{"text":"ヘルキューブ"}', Health: 150.0f, Size: 4, ArmorItems: [{}, {}, {}, {id: "minecraft:iron_helmet", Count: 65b, tag: {Enchantments: [{lvl: 5s, id: "minecraft:thorns"}, {lvl: 5s, id: "minecraft:projectile_protection"}], Damage: 0}}], Attributes: [{Base: 150.0d, Name: "minecraft:max_health"}, {Base: 0.3d, Name: "minecraft:movement_speed"}, {Base: 1.0d, Name: "minecraft:knockback_resistance"}, {Base: 32.0d, Name: "minecraft:follow_range"}], id: "minecraft:magma_cube", AbsorptionAmount: 150.0f, active_effects: [{show_particles: 0b, duration: 2147483647, Id: 25b, amplifier: -1b}], CustomNameVisible: 1b}], Health: 5.0f, Attributes: [{Base: 5.0d, Name: "minecraft:max_health"}], Silent: 1b, id: "minecraft:bat", active_effects: [{show_particles: 0b, duration: 2147483647, Id: 14b, amplifier: 127b}, {show_particles: 0b, duration: 2147483647, Id: 20b, amplifier: 127b}]}], Health: 0.0f, DeathTime: 19s, Attributes: [{Base: 0.0d, Name: "minecraft:max_health"}], Xp: 0, Silent: 1b, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager", active_effects: [{show_particles: 0b, duration: 2147483647, Id: 14b, amplifier: 127b}]}

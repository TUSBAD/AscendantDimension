...
data modify storage asset: mob set value {Passengers: [{Passengers: [{CustomName: '{"text":"Hunter","color":"red","bold":true}', Health: 630.0f, ArmorItems: [{id: "minecraft:leather_boots", Count: 1b, tag: {display: {color: 16711680}, Enchantments: [{lvl: 1s, id: "minecraft:protection"}], Damage: 0}}, {id: "minecraft:leather_leggings", Count: 1b, tag: {display: {color: 16711680}, Enchantments: [{lvl: 1s, id: "minecraft:protection"}], Damage: 0}}, {id: "minecraft:leather_chestplate", Count: 1b, tag: {display: {color: 16711680}, Enchantments: [{lvl: 1s, id: "minecraft:protection"}], Damage: 0}}, {id: "minecraft:anvil", Count: 1b, tag: {Enchantments: [{lvl: 1s, id: "minecraft:protection"}]}}], Attributes: [{Base: 630, Name: "minecraft:max_health"}, {Base: 0.25d, Name: "minecraft:movement_speed"}, {Base: 30, Name: "minecraft:attack_damage"}, {Base: 5, Name: "minecraft:attack_knockback"}], Silent: 1b, id: "minecraft:zombie", active_effects: [{duration: 20000000, Id: 8, amplifier: 3b}, {show_particles: 0b, duration: 2000000, Id: 14, amplifier: 1b}], HandItems: [{id: "minecraft:iron_axe", Count: 1b}, {id: "minecraft:iron_axe", Count: 1b}]}], Health: 300.0f, Size: 2, Attributes: [{Base: 300, Name: "minecraft:max_health"}, {Base: 50, Name: "minecraft:follow_range"}, {Base: 20, Name: "minecraft:attack_damage"}], Silent: 1b, id: "minecraft:slime", HasVisualFire: 1b, Tags: ["Garbage"], active_effects: [{duration: 200000000, Id: 8, amplifier: 3b}, {show_particles: 0b, duration: 2000000, Id: 14, amplifier: 1b}]}], id: "minecraft:villager", Tags: ["Garbage"]}

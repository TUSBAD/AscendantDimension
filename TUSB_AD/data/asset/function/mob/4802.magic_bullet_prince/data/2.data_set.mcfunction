...
##### 魔弾の皇子 #####
    ...
    ### Attributes
    # 最大体力
    data modify storage asset: mob.Attributes append value {Name:minecraft:max_health, Base:444}
    # (近接)攻撃力
    data modify storage asset: mob.Attributes append value {Name:minecraft:attack_damage, Base:5}
    # 移動速度
    data modify storage asset: mob.Attributes append value {Name:minecraft:movement_speed, Base:0.5}
    # 防具値
...
##### 魔のワゴン #####
    ...
    ### Attributes
        ...
        # data modify storage asset: mob.Attributes append value {Name:generic.armor_toughness, Base:12}
        # ノックバック耐性(0~1)
        data modify storage asset: mob.Attributes append value {Name:minecraft:knockback_resistance, Base:0.0}
        # 索敵範囲
        data modify storage asset: mob.Attributes append value {Name:minecraft:follow_range, Base:32}
        # 攻撃のノックバック(0~5)
        # data modify storage asset: mob.Attributes append value {Name:generic.attack_knockback, Base:1}

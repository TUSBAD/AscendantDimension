...
data modify storage asset: mob set value {Passengers: [{Fuse: 1s, CustomName: '{"text":"パニッククリーパー"}', Health: 20.0f, Attributes: [{Base: 20.0d, Name: "minecraft:max_health"}, {Base: 0d, Name: "minecraft:knockback_resistance"}, {Base: 1.0d, Name: "minecraft:movement_speed"}], id: "minecraft:creeper", ExplosionRadius: 1b, active_effects: [{show_particles: 0b, duration: 2000000000, Id: 8b, amplifier: 1b}], CustomNameVisible: 1b}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}

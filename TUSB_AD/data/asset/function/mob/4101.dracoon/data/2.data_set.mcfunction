...
data modify storage asset: mob set value {Passengers:[{ArmorDropChances:[0.0f,0.085f,0.085f,0.1f],CustomName:'{"text":"§lどらクーン"}',Health:40.0f,ArmorItems:[{id:"leather_boots",Count:0b,tag:{ench:[{lvl:0s,id:0s},{lvl:10s,id:8s},{lvl:10,id:4}],display:{color:0}}},{},{},{id:"dragon_head",Count:1b,tag:{display:{Name:'{"text":"大当たりw"}'}},Damage:5}],Attributes:[{Base:0.15d,Name:"minecraft:movement_speed"},{Base:40.0d,Name:"minecraft:max_health"}],HandDropChances:[0.05f,0.5f],Silent:1b,DeathLootTable:"empty",id:"wither_skeleton",CustomNameVisible:1b,HandItems:[{id:"bow",Count:1b,tag:{Enchantments:[{lvl:5,id:"power"}],RepairCost:1000000000,HideFlags:32,display:{Name:'{"text":"§5§lトンボキリ"}'},AttributeModifiers:[{UUID:[I;993979891,-1905046002,-1692252393,-402719724],Amount:-0.0125d,Slot:"mainhand",AttributeName:"minecraft:max_health",Operation:2,Name:"wax"},{UUID:[I;993979890,-1905046001,-1692252390,-402719723],Amount:0.1d,Slot:"mainhand",AttributeName:"minecraft:movement_speed",Operation:0,Name:"wax"}]},Damage:0s},{id:"tipped_arrow",Count:1b,tag:{custom_potion_effects:[{duration:60,id:"minecraft:glowing",amplifier:1b},{duration:60,id:"minecraft:levitation",amplifier:1b}],HideFlags:32,display:{Lore:['{"text":"§7相手を風船のように浮かせる矢。"}'],Name:'{"text":"§9§lバルーン・アローン"}'}}}]}],Health:0.0f,DeathTime:19s,id:"villager",active_effects:[{show_particles:0b,duration:20,id:"minecraft:invisibility",amplifier:0b}]}

...
## メインハンド
execute if data entity @s SelectedItem{id:"minecraft:chorus_fruit"} run function player:eating_fruit/drop/mainhand
## オフハンド
execute if data entity @s Inventory[{id:"minecraft:chorus_fruit",Slot:-106b}] run function player:eating_fruit/drop/offhand

advancement revoke @s only player:use/eating_fruit

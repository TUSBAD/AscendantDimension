#> player:custom_item/kyoumei/loop
#
#
#
# @within function player:custom_item/kyoumei/
...
# ループ処理
    execute if data storage item: Inventory[0] run function player:custom_item/kyoumei/loop

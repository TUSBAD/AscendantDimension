...
# めり込み死
    execute if entity @s[scores={LiveTime=1..},predicate=entity:player] if block ^ ^ ^ #lib:unbreakable anchored eyes if block ^ ^ ^ #lib:unbreakable run function player:kill/unbreakable_block

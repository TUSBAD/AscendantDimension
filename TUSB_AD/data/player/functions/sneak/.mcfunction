...
# 近くに墓がある場合、墓からものを取り出す
    execute if entity @s[scores={LiveTime=1..},predicate=entity:player] if score @s SneakTime matches 3 as @e[type=item_display,tag=Tomb,distance=..1] at @s run function player:death_item_drop/tomb_drop

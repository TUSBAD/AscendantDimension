#> area:dimension/purgatory/boss/left_beam/
# 左目からのビーム
### Copyright © 2022 赤石愛
...
### ビーム発射！！
schedule function area:dimension/purgatory/boss/left_beam/schedule 1t
schedule function area:dimension/purgatory/boss/left_beam/blast 1s

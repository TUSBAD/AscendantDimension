#> area:dimension/tocult/castle/fix
#
#
...
execute in minecraft:overworld run data merge block 1389 80 2273 {Command:"/playsound minecraft:entity.ender_dragon.death master @a[distance=..64] ~ ~ ~ 1 2 0.2"}

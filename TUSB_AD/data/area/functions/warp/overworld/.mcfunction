...
### スキル設定場からエクストラドメイン
execute positioned -2722 89 -268 align xyz if entity @s[dx=0,dy=0,dz=0] run function area:warp/overworld/extra/enter
### エクストラドメインからスキル設定場
...
execute positioned 58 66 702 align xyz if entity @s[dx=0] unless entity @e[dx=0,type=item,tag=SealBreakerItem] positioned ~0.5 ~ ~0.5 run function area:warp/overworld/gullivers_land/red

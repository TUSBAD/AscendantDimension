#> area:dimension/nether/athletic/pattern6/count_up/3
# パターン６
### Copyright © 2022 赤石愛
...
data modify storage area: pattern6.time set value 3

execute in minecraft:overworld run schedule function area:dimension/nether/athletic/pattern6/count_up/reset 1s

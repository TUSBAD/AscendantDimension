#> area:dimension/purgatory/boss/lightning_bolt/schedule
# ライトニングボルト
### Copyright © 2022 赤石愛
...
### まだ残り回数があったら繰り返し
execute store result storage area: lightning_bolt_count int 0.9999999999 run data get storage area: lightning_bolt_count
execute unless data storage area: {lightning_bolt_count:0} in minecraft:overworld run schedule function area:dimension/purgatory/boss/lightning_bolt/schedule 1t

...
execute unless data storage world: {lightning_bolt_count:0} in minecraft:overworld run schedule function area:dimension/purgatory/boss/lightning_bolt/schedule 1t

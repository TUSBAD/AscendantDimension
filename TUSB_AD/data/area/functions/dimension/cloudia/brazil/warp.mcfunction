#> area:dimension/cloudia/brazil/warp
# ブラジルワープ
### Copyright © 2022 赤石愛
...
## スポナーにサイレントをつけて音バグ回避
execute at @s[scores={Job=1..}] in minecraft:overworld run schedule function area:dimension/cloudia/brazil/apply_silent 1s

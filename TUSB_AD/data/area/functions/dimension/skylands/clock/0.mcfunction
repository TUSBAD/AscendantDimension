#> area:dimension/skylands/clock/0
# 時計島起動前
### Copyright © 2022 赤石愛
...
### 時計島変身
execute in minecraft:overworld positioned 4001 70 4001 run function area:dimension/skylands/clock/clone

### 時計島の段階を記録
data modify storage area: clock_stage set value 0

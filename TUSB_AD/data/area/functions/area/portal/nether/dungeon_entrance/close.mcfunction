#> area:area/portal/nether/dungeon_entrance/close
# 煉獄 入り口のワープ閉じる
### Copyright © 2022 赤石愛
...
data modify storage area: portal_name set value "煉獄 入り口"
data remove storage area: portal.nether.dungeon_entrance
execute positioned 12 15 -76 run function area:area/portal/close

#> area:area/portal/nether/dungeon_up/close
# 迷い断ち切る地へのワープ閉じる
### Copyright © 2022 赤石愛
...
data modify storage area: portal_name set value "煉獄 迷い断ち切る地"
data remove storage area: portal.table_mountain.waterway_village
execute positioned -1948 123 -55 run function area:area/portal/close

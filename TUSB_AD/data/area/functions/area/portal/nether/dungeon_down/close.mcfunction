#> area:area/portal/nether/dungeon_down/close
# 恐れ断ち切る地へのワープ閉じる
### Copyright © 2022 赤石愛
...
data remove storage area: portal.nether.dungeon_down
execute positioned -1948 118 -55 run function area:area/portal/close

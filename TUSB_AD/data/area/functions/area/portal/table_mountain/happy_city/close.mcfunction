#> area:area/portal/table_mountain/happy_city/close
### 幸福街のワープ閉じる
...
data remove storage area: portal.table_mountain.happy_city
execute positioned 55 54 -2190 run function area:area/portal/close

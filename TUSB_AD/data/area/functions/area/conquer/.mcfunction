...
execute if data storage world: conquer.count{total:50} run schedule function area:area/conquer/island_complete_50 1t

# 80島攻略した場合の処理
execute if data storage world: conquer.count{total:80} as @a run function area:area/conquer/island_complete_80

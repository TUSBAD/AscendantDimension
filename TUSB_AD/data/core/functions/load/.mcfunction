...
execute unless score #Ticks Count matches 0.. run function core:load_once
execute unless score #Ticks Count matches 0.. run function settings:core/define/gamerule

...
#> 407:Nightmare
    ...
    execute unless data storage core: difficult.world{level:"nightmare"} if score @s ChangeSettings matches 407 run function core:game_menu/show_difficulty_info/nightmare

...
tellraw @s ""
tellraw @s {"translate":"[牧師] この選択で宜しいですか？ [%1$s] / [%2$s]","with":[{"translate":"はい","color":"green","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 405"},"hoverEvent":{"action":"show_text","contents":{"translate":"30秒後に変更され、その後1時間は難易度変更できません。\nカウントダウン中にキャンセルも可能です。"}}},{"translate":"いいえ","color":"red","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 400"},"hoverEvent":{"action":"show_text","contents":{"translate":"難易度選択一覧に戻ります。"}}}]}
tellraw @s "====================================================="
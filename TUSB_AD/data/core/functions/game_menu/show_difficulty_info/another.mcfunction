#> core:game_menu/show_difficulty_info/another
#
# アナザーに変更
#
...
#>難易度表示
tellraw @s [{"translate":"難易度を"},{"nbt":"difficult.another.text","storage":"core:","color":"#FF00FF"},{"translate":"にすると、以下の変更点があります。"}]
tellraw @s ""
tellraw @s ["",{"text":"・","bold":true},{"translate":"レベルアップ必要経験値："},{"translate":"150%","color":"#FF2A2A"}]
tellraw @s ["",{"text":"・","bold":true},{"translate":"嫌な予感の内容："},{"translate":"攻略率毎に変化","color":"#FF2A2A"}]
tellraw @s ["",{"text":"・","bold":true},{"translate":"嫌な予感の発生間隔："},{"translate":"15分～30分","color":"#FF2A2A"}]
...
tellraw @s ["",{"text":"・","bold":true},{"translate":"ボスモンスター体力補正："},{"translate":"150%","color":"#FF2A2A"}]
tellraw @s ["",{"text":"・","bold":true},{"translate":"マルチ時ボス体力補正："},{"translate":"110%","color":"#FF2A2A"}]
tellraw @s ["",{"text":"・","bold":true},{"translate":"MP自然回復速度："},{"translate":"75%","color":"#FF2A2A"}]
tellraw @s ["",{"text":"・","bold":true},{"interpret":true,"storage":"effect:","nbt":"BadEffectsName.Doom"},{"translate":"："},{"translate":"10秒","color":"#00e372"}]
...
tellraw @s ""
tellraw @s {"translate":"[牧師] この選択で宜しいですか？ [%1$s] / [%2$s]","with":[{"translate":"はい","color":"green","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 406"},"hoverEvent":{"action":"show_text","contents":{"translate":"30秒後に変更され、その後1時間は難易度変更できません。\nカウントダウン中にキャンセルも可能です。"}}},{"translate":"いいえ","color":"red","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger ChangeSettings set 400"},"hoverEvent":{"action":"show_text","contents":{"translate":"難易度選択一覧に戻ります。"}}}]}
tellraw @s "====================================================="
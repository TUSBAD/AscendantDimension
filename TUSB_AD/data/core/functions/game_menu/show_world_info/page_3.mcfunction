...
tellraw @s [{"nbt":"area_name.hellheimr","storage":"area:","color":"#87dada","clickEvent":{"action": "run_command","value": "/trigger ChangeSettings set 320"}}," : ",{"score":{"name": "_","objective": "Calc"}},"/",{"score":{"name": "#","objective": "_"}}]

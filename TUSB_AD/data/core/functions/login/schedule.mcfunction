...
execute if data storage core: difficult.world{level:"picnic"} run tellraw @a[tag=LoginMessage] [{"storage":"core:","nbt":"Prefix.INFO","bold": true},{"translate":"現在の難易度"}," : ",{"translate":"ピクニック","color":"#80ff00"}]
...
execute if data storage core: difficult.world{level:"nightmare"} run tellraw @a[tag=LoginMessage] [{"storage":"core:","nbt":"Prefix.INFO","bold": true},{"translate":"現在の難易度"}," : ",{"translate":"ナイトメア","color":"#2848ff"}]
### 祈りが表示できれば表示

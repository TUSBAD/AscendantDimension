#> player:show_text/sneak_menu/show_world_info/templete/templete
#
#> ワールド情報テンプレート
#
#
...
# tellraw @s [" ",{"storage":"core:","nbt":"Prefix.TIPS"}," ",{"translate": "%1$s：未攻略","with":[{"text":"0","font":"ender_eye","color":"gray"}]}," / ",{"translate": "%1$s：攻略済","with":[{"text":"1","font":"ender_eye"}]}]
# tellraw @s [{"translate":"[%1$s]","color":"#ffffff","with":[[" ",{"nbt":"area_name.area","storage":"area:","color":"#b7b7b7"}," "]]}]
